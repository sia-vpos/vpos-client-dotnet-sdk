...
namespace VPOS_Test
{
    class Program
    {
        private const string SHOP_ID = "129281292800109";
        private const string PAN_ALIAS = "0000409500729966732";

        private const string MAC_KEY_VPOS =
            "fU-9et-s-Sj8W---E8uhUDu9fEzqr8hH3L95s48r9nq-cq3cBXbp-tZsvGQU--t-nqmtaW-7x-7-C2PdcuFdbHuShQ-pYVWnr-4-";

        private const string API_RESULT_KEY =
            "E-vmE-GHXmx73-Lfg24LztZ-7-yCyVsKn4QXphL5qzf-Kr-Cf-JWpZwZgaZRA5dR9V677xL4uCbc-Ce--8h2-tdrSu--QKjF-nZh";

        private const string MAC_KEY_REDIRECT =
            "VnFBty7us-7QubjwHcjFaq4hb5-5n5-VdaymsXfqukzd3nhYhsLvuL5nFs-sCrJT--n9-J7zghhUYpFUw6q4KxCQ-XND6dV—abW";
        ...
        private const string OPERATOR_ID = "John Doe";
        ...
        static void TestAuth3ds()
        {
            ...
            requestData.OrderID = random.Next(999999999).ToString();
            requestData.PAN = PAN_ALIAS;
            requestData.ExpDate = "2112";
            requestData.AccountingMode = "I";
            requestData.CVV2 = "111";
            requestData.Network = "98";
            requestData.InPerson = "S";
            requestData.MerchantURL = "http://djidjijsi";

            var request = new BPWXmlRequest<AuthorizationRequest>(requestData);
